...
public class BinaryOutputValues {
	...
	private int BOwriteToStringCells[] = { 25, 35, 36, 47, 48, 49, 50, 51, 52, 63, 86, 93, 94, 97, 105, 106, 107, 108,
			109, 111, 112, 113, 114, 125 };
	private String BOwriteStringValuestoCell[] = { /* 25 */"Normal", /* 35 */"WAHR", /* 36 */"FALSCH",
			...
			/* 111 */"FALSCH", /* 112 */"WAHR", /* 113 */"FALSCH", /* 114 */"WAHR", /* 125 */"Alarm", };
