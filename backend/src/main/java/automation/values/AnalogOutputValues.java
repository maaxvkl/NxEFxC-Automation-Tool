...
public class AnalogOutputValues {
	...
	private int AOwriteToStringCells[] = { 26, 37, 38, 40, 42, 48, 49, 50, 51, 52, 56, 57, 63, 86, 93, 94, 106, 107,
	...
	private int AOwriteToDoubleCells[] = { 27, 30, 39, 41, 43, 44, 58, 59, 60, 61, 64, 70, 71, 73, 99, 100, 115, 120,
			121, 122, 126 };
	private double AOwriteDoubleValuesToCell[] = { /* 27 */0.2, /* 30 */0, /* 39 */100, /* 41 */0.02, /* 43 */0.1,
